...
export default function CountdownTimer({ lastGMTimestamp, onClose }: CountdownTimerProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br from-purple-700 to-fuchsia-900 rounded-3xl p-8 max-w-md w-full shadow-2xl text-center">
        <h2 className="text-white text-3xl font-bold mb-4">
          Already Pumped Today! 🚀
        </h2>
        <div className="text-gray-300 text-xl mb-6">
          Time to next pump:
        </div>
        <div className="flex justify-center gap-4 mb-8">
          <div className="bg-purple-900/50 rounded-xl p-4 min-w-[80px]">
